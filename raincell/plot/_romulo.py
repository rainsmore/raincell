...
# %% ../../nbs/20_plot.romulo.ipynb #01e4de4e
...
# %% ../../nbs/20_plot.romulo.ipynb #63b180c2
def romulo_plot_cml(
...
def romulo_plot_gauges(
    ...
    if getattr(gauges, id_dim).size > 1:
        ...
        gauges.plot.imshow(ax=ax, x="time", cmap=cmap, vmax=vmax)
        ax.set_title("")
    ax.set_ylabel("Gauge")
...
# %% ../../nbs/20_plot.romulo.ipynb #795892b5
def romulo_plot(
